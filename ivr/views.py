...
from lib.settings import sid, token
...
def hasInterest(request):
	...
	return Response("hasInterest", status=status.HTTP_302_FOUND);
...
def hasNotImplemented(request):
	...
	return Response("hasNotImplemented", status=status.HTTP_302_FOUND);
